     ...
     <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="box-title">Dana Pengeluaran</h3>
                    </div>
                    <div class="col-sm-6">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal form-material" id="form">
            ...
            <div class="form-group">
                <label class="col-md-12">Nama Pengeluaran</label>
                <div class="col-md-12">
                    <input type="text" placeholder="Nama Pengeluaran" class="form-control form-control-line" name="nama_bayar" id="nama_bayar"> 
                    <span class="help-block"></span>
                </div>

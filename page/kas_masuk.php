...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Pemasukan</h4> </div>
     ...
     <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="box-title">Dana Pemasukan</h3>
                    </div>
                    <div class="col-sm-6">
        ...
        <form class="form-horizontal form-material" id="form">
            <div class="form-group">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="nama" id="nama" placeholder="Nama" class="form-control form-control-line">
...
function edit_kas_masuk(id){
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('.modal-title').text('Edit Pemasukan '); // Set title to Bootstrap modal title

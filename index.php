...
<head>
    ...
    <title>Keuangan - Kopi Kobatins</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="fa fa-bars"></i></a>
                <div class="top-left-part"><a class="logo" href="<?= base_url ?>"><b><img src="<?php echo base_url ?>img/kobatins_circle.png"  /></b><span class="hidden-xs"><img src="<?php echo base_url ?>img/kobatins.png"/></span></a></div>
            ...
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    <li style="padding: 10px 0 0;">
                        <a href="<?= base_url ?>" class="waves-effect"><i class="fa fa-clock-o fa-fw" aria-hidden="true"></i><span class="hide-menu">Home</span></a>
                    </li>
					<li>
                    ...
                    <li>
                        <a href="#dana_masuk" id="kas_masuk" class="waves-effect"><i class="fa fa-bank fa-fw" aria-hidden="true"></i><span class="hide-menu">Pemasukan</span></a>
                    </li>
                        ...
                        <div class="white-box">
                            <div class="col-in row">
                                <div class="col-md-12 col-sm-12 col-xs-12"> <i class="linea-icon linea-basic" data-icon="&#xe01b;"></i>
                                    <h5 class="text-center text-muted vb">Total Pemasukan</h5>
                                </div>
    ...
    $(document).ready(function() {
      ...
      // $.toast({
           // heading: 'Selamat Datang di E-cash Admin',
           //text: 'Aplikasi pengeloala Kas Keuangan by Oezzi16.com.',
          //  position: 'top-right',
           //loaderBg: '#ff6849',
         //   icon: 'info',
         //   hideAfter: 3500,
